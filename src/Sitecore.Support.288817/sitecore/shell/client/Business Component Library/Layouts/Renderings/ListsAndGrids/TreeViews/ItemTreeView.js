    ...
    var control = {
        ...
        view:
        {
            initialized: function () {
                 ...
                 * -------------     AFTER --------------------------------- */
                var languageFromQueryString = location.search.substring(1).split("&")
                    .map(function (i) { var k = i.split("="); if (k[0] == "la") return k[1]; return ""; })
                    .reduce(function (s, c) { return s + c; }, "");
                this.model.set("contentLanguage", this.$el.attr("data-sc-contentlanguage") || languageFromQueryString);
                 /* ----------------------------------------------------------*/
